...
祝我们的祖国节日快乐，也祝大家中秋快乐！  
版本特别记事：https://www.yangblogs.com
...
### 系统更新
如果您是已经安装过 cms的用户,请查看 update 目录下的 sql 升级文件,根据自己的下载的程序版本进行更新

### API开发 (支持app,小程序,web)
如果你需要 `api` 开发请下载:  
ThinkCMS API :https://www.yangblogs.com
...
`YGWCMS 高级交流群`:
高级群专属权益:  
第一波:两个后台风格(YGWCMS官网风格后台主题,蓝色风格后台主题)  
第二波:YGWCMS完全开发手册离线版(PDF,EPUB,MOBI格式)  
更多专属权益正在路上...
...
* 修复`cms\lib\Auth\check`方法逻辑问题 #252
